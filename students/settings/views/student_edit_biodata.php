<html lang="en">
    ...
    <head>
        ...
        <link href="<?php echo base_url(); ?>assets/students/dist/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css" rel="stylesheet" type="text/css" />      
        <link href="<?php echo base_url(); ?>assets/students/dist/assets/css/pages/wizard/wizard-students.css" rel="stylesheet" type="text/css">
        ...
        <link href="<?php echo base_url(); ?>assets/students/dist/assets/css/pages/fonts/dropify.css" rel="stylesheet" type="text/css" />
                    ...
                    <div class="login-form text-center p-7 position-relative overflow-hidden">
                        ...
                        <div class="d-flex flex-center mb-3">
                            <div class="text-center">
                                <h3 class="font-mobile display-4 text-warning font-weight-boldest">UPDATE BIODATA SISWA</h3>
                            </div>
                        </div>
                        <!--end::Login Header-->
<!--                        <div class="row flex-center mb-5">
                                ...
                                <div class="card-body d-flex align-items-center py-0 mt-2">
                                    <div class="d-flex flex-column flex-grow-1 py-1 py-lg-5">
                                        ...
                                        <span class=" text-dark-75 font-size-md">
                                            Berikut merupakan halaman ganti Email dan Password Anda.
                                        </span>
                                    </div>
                        ...
                        <div class="d-flex flex-column flex-root">
                            ...
                            <div class="row">
                                <!--begin::Card-->
                                <div class="card card-custom text-left bg-warning-o-40" >
                                    <!--begin::Form-->
                                    <div class="card-body p-0">
                                        ...
                                        <div class="wizard wizard-2" id="kt_wizard" data-wizard-state="step-first" data-wizard-clickable="false">
                                            ...
                                            <div class="wizard-body py-5 px-5 py-lg-20 px-lg-15">
                                                ...
                                                <div class="row px-4">
                                                    <div class="col-xl-12">
                                                        <form class="form" method="POST" action="<?php echo site_url('students/settings/account/update_student_biodata'); ?>" enctype="multipart/form-data" id="kt_form_students">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-xl-6 col-6">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <span class="form-text text-dark"><b class="text-danger">*WAJIB DIISI, </b>isikan NISN Siswa</span>
                                                                    ...
                                                                    <div class="col-xl-6 col-6">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="input-group input-group-lg input-group-solid">
                                                                                ...
                                                                                <input type="text" name="nis" readonly="" value="<?php echo $student[0]->nis; ?>" class="form-control form-control-solid form-control-lg" id="kt_maxlength_nisn" maxlength="10" placeholder="Inputkan NISN Siswa" />
                                                                            </div>
        ...
        <script src="<?php echo base_url(); ?>assets/students/dist/assets/js/pages/crud/forms/widgets/select2.js"></script>
        <script src="<?php echo base_url(); ?>assets/students/dist/assets/js/pages/custom/wizard/wizard-students.js"></script>
        <script src="<?php echo base_url(); ?>assets/students/dist/assets/js/pages/crud/forms/widgets/bootstrap-switch.js"></script>      
        <script src="<?php echo base_url(); ?>assets/students/dist/assets/js/pages/crud/forms/widgets/jquery-mask.js"></script>
        <script src="<?php echo base_url(); ?>assets/students/dist/assets/js/pages/crud/forms/widgets/bootstrap-datepicker.js"></script>
        <script src="<?php echo base_url(); ?>assets/students/dist/assets/js/pages/crud/forms/widgets/bootstrap-daterangepicker.js"></script>
        <script src="<?php echo base_url(); ?>assets/students/dist/assets/js/pages/crud/forms/widgets/bootstrap-maxlength.js"></script>
        <script src="<?php echo base_url(); ?>assets/students/dist/assets/js/pages/crud/forms/widgets/bootstrap-switch.js"></script>
        <script src="<?php echo base_url(); ?>assets/students/dist/assets/js/dropify.js"></script>
            ...
            $(document).ready(function () {
                ...
                $('#alamat').click(function () {
                    if ($(this).prop("checked") == true) {
                        ...
                        var url = "<?php echo site_url('students/settings/account/add_ajax_kab'); ?>/" + id_prov_kk + "/" + id_kab_kk;
                        $('#kabupaten_kota_kk').load(url);
                        var url = "<?php echo site_url('students/settings/account/add_ajax_kec'); ?>/" + id_prov_kk + "/" + id_kab_kk + "/" + id_kec_kk;
                        $('#kecamatan_kk').load(url);
                        var url = "<?php echo site_url('students/settings/account/add_ajax_des'); ?>/" + id_prov_kk + "/" + id_kab_kk + "/" + id_kec_kk + "/" + id_des_kk;
        ...
        <script>
            $(document).ready(function () {
                ...
                if ('<?php echo $student[0]->status_alamat; ?>' == 0) {
                    ...
                    var url = "<?php echo site_url('students/settings/account/add_ajax_kab'); ?>/" + id_prov_dom + "/" + id_kab_dom;
                    $('#kabupaten_kota_dom').load(url);
                    var url = "<?php echo site_url('students/settings/account/add_ajax_kec'); ?>/" + id_prov_dom + "/" + id_kab_dom + "/" + id_kec_dom;
                    $('#kecamatan_dom').load(url);
                    var url = "<?php echo site_url('students/settings/account/add_ajax_des'); ?>/" + id_prov_dom + "/" + id_kab_dom + "/" + id_kec_dom + "/" + id_des_dom;
                ...
                var url = "<?php echo site_url('students/settings/account/add_ajax_grade'); ?>/" + id_grade_level + "/" + id_tingkat;
                $('#kelas').load(url);
