<html lang="en">
    ...
    <body id="kt_body" class="quick-panel-right demo-panel-right offcanvas-right header-fixed subheader-enabled page-loading">
                    ...
                    <div class="login-form text-center p-7 position-relative overflow-hidden">
                        ...
                        <div class="d-flex flex-center mb-3">
                            <div class="text-center">
                                <h3 class="font-mobile display-4 text-warning font-weight-boldest">GANTI EMAIL/PASSWORD</h3>
                            </div>
                        </div>
                        <!--end::Login Header-->
                        ...
                        <div class="login-signin">
                            ...
                            <div class="row" id="kt_form">
                                ...
                                <div class="card card-custom text-center" >
                                    <!--begin::Form-->
                                    <form class="form" novalidate="novalidate" action="<?php echo site_url('students/settings/account/update_email_password'); ?>" enctype="multipart/form-data" method="post" id="kt_edit_profile_form">
                                        ...
                                        <div class="card-body ">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4 col-6">
                                                    <div class="form-group">
                                                        <label>NIS</label>
                                                        <input type="text" readonly class="form-control form-control-lg form-control-solid" value="<?php echo $account[0]->nis; ?>" placeholder="Isikan NIK KTP"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-6 col-6">
                                                    <div class="form-group">
                                                        <label>Email</label>
                                                        <input type="text" name="email" value="<?php echo $account[0]->email; ?>" class="form-control  form-control-lg"  placeholder="Isikan Email Akun"/>
                                                        <span class="form-text text-dark"><b class="text-danger">*WAJIB DIISI, </b>isikan Email Anda</span>               
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-6">
                                                    <div class="form-group">
                                                        <label>No Handphone</label>
                                                        <input type="text" name="nomor_handphone" value="<?php echo $account[0]->nomor_handphone; ?>" class="form-control form-control-lg"  placeholder="Isikan Email Akun"/>
                                                        <span class="form-text text-dark"><b class="text-danger">*WAJIB DIISI, </b>isikan Nomor HP Anda</span>               
                                                    </div>
                                                </div>                                             
                                            </div>
                                            <div class="row">                                                
        ...
        <script src="<?php echo base_url(); ?>assets/students/dist/assets/js/pages/custom/login/edit-profile.js"></script>
        <!--end::Page Scripts-->
