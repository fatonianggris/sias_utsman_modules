                ...
                <div class="d-flex flex-center flex-row-fluid bgi-size-cover bgi-position-top bgi-no-repeat" style="background-image: url('<?php echo base_url(); ?>assets/students/dist/assets/media/bg/bg-3.jpg');">
                    <div class="login-form text-center p-7 position-relative overflow-hidden">
                        ...
                        <div class="login-signin">
                            ...
                            <div class="text-center">
                                <a href="<?php echo site_url('students/auth/logout'); ?>" type="button" class="btn btn-warning button-load font-weight-bold px-9 py-4 my-3 mx-4 mt-1"><li class="fas fa-door-open font-size-h4"></li> Keluar</a>
                            </div>
                            <!--end::form-->  
