...
<body id="kt_body" class="quick-panel-right demo-panel-right offcanvas-right header-fixed subheader-enabled page-loading">
                ...
                <div class="login-form text-center p-7 position-relative overflow-hidden">
                    ...
                    <div class="d-flex flex-center mb-3">
                        <div class="text-center">
                            <h3 class="font-mobile display-4 text-warning font-weight-boldest">RIWAYAT TAGIHAN DU</h3>
                        </div>
                    </div>
                    <!--end::Login Header-->
                    <div class="row flex-center mb-5">
                        <div class="col-6 float-left">
                            <a href="<?php echo site_url('students/dashboard'); ?>" type="button" class="btn btn-danger button-load float-left font-weight-bold">
                                ...
                                <div class="card-body d-flex align-items-center py-0 mt-2">
                                    <div class="d-flex flex-column flex-grow-1 py-1 py-lg-5">
                                        ...
                                        <span class=" text-dark-75 font-size-md mb-1">
                                            Berikut riwayat Tagihan DU atas nama <b>"<?php echo strtoupper(strtolower($user[0]->nama_lengkap)); ?>" (<?php echo strtoupper(strtolower($user[0]->nis)); ?>)</b>.<br>
                        ...
                        <div class="row mb-5">
                            <div class="card card-custom bg-danger-o-50 col-12">
                                ...
                                <div class="card-body">
                                    <!--begin::Stats-->
                                    <div class="">
                                        <div class="text-danger font-weight-bolder font-size-h5">SISA TUNGGAKAN</div>
                                        <div class="font-weight-bolder font-size-h1">
                                            <?php if ($loan) { ?>
                                                <?php if ($loan[0]->total_tunggak == NULL || $loan[0]->total_tunggak == "") { ?>
                                                    Rp. 0
                                                <?php } else { ?>
                                                    <?php echo "Rp. " . number_format(intval($loan[0]->total_tunggak)); ?>
                                                <?php } ?>
                                            <?php } else { ?>
                                                Rp. 0
                                            <?php } ?>
                        ...
                        <div class="row ">
                            ...
                            <div class="card card-custom">
                                <div class="card-body">
                                                            ...
                                                            <div class="col-md-3 my-2 col-12">
                                                                <div class="d-flex align-items-center">
                                                                    <select class="form-control datatable-input" data-col-index="10">
                                                                        <option value="">Pilih Thn Ajaran</option>
                                                                        <?php
                                                                        if (!empty($schoolyear)) {
                                    ...
                                    <!--begin: Datatable-->
                                    <table class="table table-separate table-hover table-light-success table-checkable font-size-sm " id="kt_datatable_du">
                                        <thead>
                                            <tr>
                                                <th></th>
                                                <th>Nama Siswa</th>
    ...
    <script src="<?php echo base_url(); ?>assets/students/dist/assets/js/pages/crud/datatables/search-options/document-payment-du.js"></script>
    <script>
