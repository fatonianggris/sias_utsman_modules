<html lang="en">
                    ...
                    <div class="login-form text-center p-7 position-relative overflow-hidden">
                        ...
                        <div class="d-flex flex-center mb-3">
                            <div class="text-center">
                                <h3 class="font-mobile display-4 text-warning font-weight-boldest">RIWAYAT TAGIHAN SISWA</h3>
                            </div>
                        </div>
                        <!--end::Login Header-->
                                    ...
                                    <div class="card-body d-flex align-items-center py-0 mt-2">
                                        <div class="d-flex flex-column flex-grow-1 py-1 py-lg-5">
                                            ...
                                            <span class=" text-dark-75 font-size-md">
                                                Berikut daftar Pengumuman terkait Akademik Sekolah Utsman <?php echo ucwords(strtolower($schoolyear_now[0]->nama_tahun_ajaran)); ?>.
                                            </span>
                                        </div>
                                                ...
                                                foreach ($announcement as $key => $value) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="font-weight-bolder text-primary">
                                                            <?php echo ucwords(strtolower($value->judul_pengumuman)); ?>
                                                        </td>
    ...
    <script src="<?php echo base_url(); ?>assets/students/dist/assets/js/pages/crud/datatables/search-options/document-announcement.js"></script>
    <script>
