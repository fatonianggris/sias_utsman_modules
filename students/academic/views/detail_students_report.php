                    ...
                    <div class="login-form text-center p-7 position-relative overflow-hidden">
                        ...
                        <div class="d-flex flex-center mb-3">
                            <div class="text-center">
                                <h3 class="font-mobile display-4 text-warning font-weight-boldest">DETAIL RAPOR SISWA</h3>
                            </div>
                        </div>
                        <!--end::Login Header-->
                                    ...
                                    <div class="card-body d-flex align-items-center py-0 mt-2">
                                        <div class="d-flex flex-column flex-grow-1 py-1 py-lg-5">
                                            ...
                                            <span class=" text-dark-75 font-size-md">
                                                Berikut Detail Rapor Online atas nama <b>"<?php echo strtoupper(strtolower($user[0]->nama_lengkap)); ?>" (<?php echo strtoupper(strtolower($user[0]->nis)); ?>)</b> yang telah ditempuh.
                                            </span>
                                        </div>
                                    ...
                                    <div class="card-header mt-2" style="justify-content: center">
                                        <div class="card-title text-center">                                
                                            <h2 class="card-label font-size-h3 font-weight-bolder">
                                                Detail Rapor "<?php echo strtoupper(strtolower($user[0]->nama_lengkap)); ?>" - <?php echo $detail_report[0]->nis; ?>
                                                <span class="text-muted pt-2 font-size-sm d-block">Berikut Rapor Siswa Kelas <?php echo strtoupper(strtolower($detail_report[0]->nama_kelas)); ?> TA <?php echo $detail_report[0]->tahun_awal; ?>/<?php echo $detail_report[0]->tahun_akhir; ?> <?php echo strtoupper(strtolower($detail_report[0]->semester)); ?></span>
                                            </h2>
                                        </div>
                                    </div>
                                    <div class="card-body text-center">
                                        <?php if ($detail_report[0]->file_rapor_siswa != NULL || $detail_report[0]->file_rapor_siswa != "") { ?>
                                            <iframe src="https://docs.google.com/viewer?url=<?php echo base_url() . $detail_report[0]->file_rapor_siswa; ?>&embedded=true" width="100%" height="500"></iframe>
                                            <a class="btn btn-success mt-5" href="<?php echo base_url() . $detail_report[0]->file_rapor_siswa; ?>" download="<?php echo strtoupper(strtolower($user[0]->nama_lengkap)); ?>-<?php echo $detail_report[0]->nis; ?>"><i class="fas fa-download"></i> Download</a>                                       
                                        <?php } else { ?>
