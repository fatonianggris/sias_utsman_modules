...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
                ...
                <div class="login-form text-center p-7 position-relative overflow-hidden">
                    ...
                    <div class="login-signin">
                        <div class="mb-8">
                            ...
                            <div class="text-danger font-weight-bold">Silahkan login sesuai Nomor Pembayaran dan Kata Sandi anda:</div>
                        </div>
                        ...
                        <form class="form" novalidate="novalidate" method="POST" action="<?php echo base_url(); ?>students/auth/login" id="kt_login_signin_form_students">
                            ...
                            <div class="form-group mb-5">
                                <input class="form-control h-auto form-control-solid py-4 px-8" type="text" placeholder="Inputkan Nomor Pembayaran Anda" name="nomor_pembayaran_dpb" autocomplete="off" />
                            </div>
                            <div class="form-group mb-5">
                            ...
                            <button id="kt_login_signin_submit" class="btn btn-warning font-weight-bold px-9 py-4 my-3 mx-4">
                                <li class="fas fa-lock"></li> Masuk
                            </button>
                        </form>
                        <div class="mt-8">
                    ...
                    <div class="login-forgot">
                        <div class="mb-5">
                            ...
                            <div class="text-warning font-weight-bold">Silahkan masukkan Nomor Pembayaran untuk mereset kata sandi.</div>
                        </div>
                        <form class="form" id="kt_login_forgot_form">
                            <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                            <div class="form-group mb-10">
                                <label class="font-size-h7 text-danger pt-5">*Nomor Penmbayaran yang terdaftar sebelumnya.</label>
                                <input id="nomor_reset" class="form-control form-control-solid h-auto py-4 px-8" type="text" placeholder="Inputkan Nomor Pembayaran Anda" name="nomor_pembayaran" autocomplete="off" />
                            </div>
    ...
    <script>
        function act_reset_password() {
            var nomor_pembayaran = $('#nomor_reset').val();
            Swal.fire({
                title: "Peringatan!",
                text: "Apakah anda yakin mengirimkan PASSWORD BARU untuk AKUN Nomor '" + nomor_pembayaran + "' yang telah terdaftarkan sebelumnya?",
                icon: "warning",
                ...
                preConfirm: () => {
                    return $.ajax({
                        ...
                        success: function(result) {
                            if (result == '1') {
                                Swal.fire("Dikirimkan!", "Password Baru telah dikirimkan ke EMAIL Anda. Silahkan cek EMAIL Anda!", "success");
                                setTimeout(function() {
                                    location.reload();
                                }, 2000);
                            } else if (result == '0') {

                                Swal.fire("Opps!", "Nomor Pembayaran Anda Tidak Terdaftar dalam sistem Kami!", "error");
                            }
                        },
