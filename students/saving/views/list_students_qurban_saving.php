...
<head>
    ...
    <link href="<?php echo base_url(); ?>assets/students/dist/assets/css/pages/login/classic/login-2.css"
        rel="stylesheet" type="text/css" />
    <link href="<?php echo base_url(); ?>assets/students/dist/assets/plugins/custom/datatables/datatables.bundle.css"
        rel="stylesheet" type="text/css" />
...
<body id="kt_body"
                ...
                <div class="login-form text-center p-7 position-relative overflow-hidden">
                    ...
                    <div class="d-flex flex-center mb-3">
                        <div class="text-center">
                            <h3 class="font-mobile display-4 text-warning font-weight-boldest">TABUNGAN QURBAN
                            </h3>
                        </div>
                    </div>
                    <!--end::Login Header-->
                    <div class="row flex-center mb-5">
                        <div class="col-6 float-left">
                            <a href="<?php echo site_url('students/dashboard'); ?>" type="button"
                                class="btn btn-danger button-load float-left font-weight-bold">
                                <li class="fa fa-home "></li> Menu
                            </a>
                        </div>
                        <div class="col-6 float-right">
                            <a onclick="window.history.back();"
                                class="btn btn-light-warning button-load font-weight-bold float-right"><i
                    ...
                    <div class="login-signin ">
                                    ...
                                    <div class="d-flex flex-column flex-grow-1 py-1 py-lg-5">
                                        ...
                                        <a
                                            class="card-title font-weight-bolder text-dark-75 font-size-h5 mb-2 text-hover-primary"><b
                                                class="text-danger">Hi,
                                                <?php echo strtoupper(strtolower($limit_word)); ?>!</b></a>
                                        <span class="text-dark-75 font-size-md">
                                            Total Saldo Tabungan Qurban Anda: <br>
                                            <p class="font-weight-boldest text-danger font-size-h4">
                                                "Rp.
                                                <?php echo number_format((double) $qurban_saldo[0]->saldo_tabungan_qurban, 0, ',', '.'); ; ?>"
                                            </p>
                                        </span>
                                    </div>
                        ...
                        <div class="row ">
                            ...
                            <div class="card card-custom">
                                                            ...
                                                            <div class="col-md-12 col-12  mb-4">
                                                                <div class="d-flex align-items-center">
                                                                    <input type="text"
                                                                        ...
                                                                        placeholder="Inputkan Nomor Transaksi"
                                                                        data-col-index="1" />
                                                                </div>
                                                            </div>
                                                                        ...
                                                                        <?php
                                                                            if (!empty($schoolyear)) {
                                                                                foreach ($schoolyear as $key => $value_sch) {
                                                                                    ?>
                                                                        <option
                                                                            value="<?php echo $value_sch->tahun_awal . '/' . $value_sch->tahun_akhir; ?>">
                                                                            <?php echo strtoupper($value_sch->tahun_awal . '/' . $value_sch->tahun_akhir); ?>
                                                                        </option>
                                                                        <?php
                                                                                }
                                                                            }
                                ...
                                <!--begin: Datatable-->
                                <table
                                    class="table table-separate table-hover table-light-success table-checkable font-size-sm "
                                    id="kt_datatable">
                                    <thead>
                                        <tr>
                                            <th></th>
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            if (!empty($qurban_saving)) {
                                                foreach ($qurban_saving as $key => $value) {
													if($value->status_kredit_debet == "1"){
														$status_transaksi = "KREDIT";
														$debet = "0";
														$kredit = $value->nominal;
													} else {
														$status_transaksi = "DEBET";
														$kredit = "0";
														$debet = $value->nominal;
													}
                                                    ?>
                                        <tr>
                                            ...
                                            <td class="font-weight-bolder text-primary">
                                                <?php echo strtoupper(strtolower($value->nomor_transaksi_qurban)); ?>
                                            </td>
                                            <td class="font-weight-bolder">
                                                <?php echo $value->status_kredit_debet; ?>
                                            </td>
                                            <td class="font-weight-bolder">
                                                <?php echo $value->id_tingkat; ?>
                                            </td>
                                            <td class="font-weight-bolder">
                                                <?php echo $value->tanggal_transaksi; ?>
                                            </td>
                                            <td class="font-weight-bolder">
                                            ...
                                            <td class="font-weight-bolder">
                                                <?php echo number_format((double) $kredit, 0, ',', '.'); ?>
                                            </td>
                                            <td class="font-weight-bolder">
                                                <?php echo number_format((double) $debet, 0, ',', '.'); ?>
                                            </td>
                                            <td class="font-weight-bolder">
                                                <b><?php echo number_format((double) $value->saldo, 0, ',', '.'); ?></b>
                                            </td>
                                        </tr>
                                        <?php
                                                }  //ngatur nomor urut
    ...
    <script src="<?php echo base_url(); ?>assets/students/dist/assets/plugins/custom/datatables/datatables.bundle.js">
    </script>
    <script
        src="<?php echo base_url(); ?>assets/students/dist/assets/plugins/custom/datatables/dataTables.checkboxes.min.js">
    </script>
    <script
        src="<?php echo base_url(); ?>assets/students/dist/assets/js/pages/crud/datatables/search-options/document-qurban-saving.js">
    </script>
    <script>
