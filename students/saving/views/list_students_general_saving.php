...
<body id="kt_body"
                ...
                <div class="login-form text-center p-7 position-relative overflow-hidden">
                    ...
                    <div class="d-flex flex-center mb-3">
                        <div class="text-center">
                            <h3 class="font-mobile display-4 text-warning font-weight-boldest">TABUNGAN UMUM
                            </h3>
                        </div>
                    </div>
                    <!--end::Login Header-->
                                ...
                                <div class="card-body d-flex align-items-center py-0 mt-2">
                                    <div class="d-flex flex-column flex-grow-1 py-1 py-lg-5">
                                        ...
                                        <span class="text-dark-75 font-size-md">
                                            Total Saldo Tabungan Umum Anda: <br>
                                            <p class="font-weight-boldest text-danger font-size-h4">
                                                "Rp. <?php echo number_format((double) $general_saldo[0]->saldo_tabungan_umum, 0, ',', '.'); ; ?>"
                                            </p>
                                        </span>
                                    </div>
                                ...
                                <table
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            if (!empty($general_saving)) {
                                                foreach ($general_saving as $key => $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="font-weight-bolder text-primary">
                                                <?php echo strtoupper(strtolower($value->nomor_transaksi_umum)); ?>
                                            </td>
    ...
    <script
        src="<?php echo base_url(); ?>assets/students/dist/assets/js/pages/crud/datatables/search-options/document-general-saving.js">
    </script>
    <script>
