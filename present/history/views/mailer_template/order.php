...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
    ...
    <body id="body" style="margin-top: 0; margin-bottom: 0; padding-top: 0; padding-bottom: 0; width: 100%; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%;" bgcolor="#F4F4F4">
                                                            ...
                                                            <tr>
                                                                <td align="center" valign="middle">
                                                                    <table border="0" cellpadding="0" cellspacing="0" align="center" class="center-float">
                                                                        <tr>
                                                                            <td valign="middle" align="center" class="img180"><img style="display:block;width:100%;max-width:130px;border:0px;" src="<?php echo base_url() . $page[0]->logo_website; ?>" width="130"  border="0"   alt="logo"></td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                            </tr>
        ...
        <table border="0" width="100%" align="center" cellpadding="0" cellspacing="0" style="width:100%;max-width:100%;">
            <tr>
                <td class="title-1" align="center" valign="top">
                                                ...
                                                <tr>
                                                    <td align="center" valign="top" class="container-padding">
                                                        ...
                                                        <table   border="0" width="100%" cellpadding="0" cellspacing="0" align="center" style="width:100%; max-width:100%;">
                                                            <tr> 
                                                                <td class="title center-text"      valign="middle" align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif; font-size:24px; line-height:28px; font-weight:lighter;font-style:normal; color:#000000;text-decoration:none;letter-spacing: 1px;">

                                                                    <strong style="color:#ff7264;" >SEKOLAH UTSMAN</strong> ISLAM TERPADU 
                                                        ...
                                                        <table border="0" width="100%" align="center" cellpadding="0" cellspacing="0" style="width:100%;max-width:100%;">
                                                            <tr>
                                                                <td align="center" valign="middle" height="18" style="font-size:18px;line-height:18px;">&nbsp;</td>
                                                            </tr>
                                                            <tr>
                                                                <td valign="middle" align="center" height="2" style="font-size:2px;line-height:2px;">
                                                                    <!-- line -->
                                                                    <table width="80" border="0" cellpadding="0" cellspacing="0" align="center" class="center-float" style="width:80px;max-width:80px;">
                                                                        <tr>
                                                                            <td class="splitter-option-a" align="center" valign="middle" height="2"  bgcolor="#000000" style="font-size:2px;line-height:2px;border-radius:6px;">&nbsp;</td>
                                                                        </tr>
                                                                    </table>
                                                                    <!-- line -->
                                                                </td>
        ...
        <table border="0" width="100%" align="center" cellpadding="0" cellspacing="0"  style="width:100%;max-width:100%;">
            <tr>
                <td class="fp-2" align="center" valign="top">
                                                        ...
                                                        <table width="600" border="0" cellpadding="0" cellspacing="0" align="center" class="row" style="width:600px;max-width:600px;">
                                                            <tr>
                                                                <td align="center" valign="top">
                                                                    ...
                                                                    <table width="600" border="0" cellpadding="0" cellspacing="0" align="center" class="row" style="width:600px;max-width:600px;">
                                                                        <tr>
                                                                            <td class="column-bg-color" align="center" valign="middle" bgcolor="#ffffff">
                                                                                <!-- container -->
                                                                                <table width="600" border="0" cellpadding="0" cellspacing="0" align="center" class="row" style="width:600px;max-width:600px;">
                                                                                    <tr>
                                                                                        <td height="500" class="autoheight" align="center" valign="middle">
                                                                                            <!-- space -->
                                                                                            <table border="0" width="100%" align="center" cellpadding="0" cellspacing="0" style="width:100%;max-width:100%;">
                                                                                                <tr>
                                                                                            ...
                                                                                            <table  border="0" width="100%" cellpadding="0" cellspacing="0" align="center" style="width:100%; max-width:100%; margin-bottom: 5px;">
                                                                                                <tr> 
                                                                                                    <td class="text center-text" valign="middle" align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif; font-size:14px; line-height:23px; font-weight:normal;font-style:normal; color:#000000;text-decoration:none;letter-spacing: 0px;">
                                                                                                        Berikut merupakan informasi terkait pemesanan formulir Anda:
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </table>
                                                                                            <!-- text -->
                                                                                                        ...
                                                                                                        <table border="2" width="100%" cellpadding="1" cellspacing="1" align="center" style="width:100%; max-width:100%;">
                                                                                                            ...
                                                                                                            <tbody>
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td class="text center-text" valign="middle" align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif; font-size:14px; line-height:23px; font-weight:bold;font-style:normal; color:#F64E60;text-decoration:none;letter-spacing: 0px;">                                                     
                                                                                                                        <?php
                                                                                                                        if ($register[0]->id_tingkat == 1) {
                                                                                                                            echo 'KB';
                                                                                                                        } else if ($register[0]->id_tingkat == 2) {
                                                                                                                            echo 'TK';
                                                                                                                        } else if ($register[0]->id_tingkat == 3) {
                                                                                                                            echo 'SD';
                                                                                                                        } else if ($register[0]->id_tingkat == 4) {
                                                                                                                            echo 'SMP';
                                                                                                                        }
                                                                                                                        ?>                                                                                                                                                                                                                                          </td>
                                                                                                                    <td class="text center-text" valign="middle" align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif; font-size:14px; line-height:23px; font-weight:bold;font-style:normal; color:#F64E60;text-decoration:none;letter-spacing: 0px;">                                                     
                                                                                                                    ...
                                                                                                                    <td class="text center-text" valign="middle" align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif; font-size:13px; line-height:23px; font-weight:normal;font-style:normal; color:#000000;text-decoration:none;letter-spacing: 0px;">                                                     
                                                                                                                        <?php echo $register[0]->tahun_ajaran; ?>
                                                                                                                    </td>
                                                                                                                </tr>                                      
                                                                                                        </table>
                                                                                                                    ...
                                                                                                                    foreach ($bank_account as $key => $value) {
                                                                                                                        ...
                                                                                                                        <tr>
                                                                                                                            ...
                                                                                                                            <td class="text center-text" valign="middle" align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif; font-size:13px; line-height:23px; font-weight:bold;font-style:normal; color:#000000;text-decoration:none;letter-spacing: 0px;">                                                     
                                                                                                                                <?php echo strtoupper($value->nomor_alatbayar); ?>
                                                                                                                            </td>
                                                                                                                            <td class="text center-text" valign="middle" align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif; font-size:13px; line-height:23px; font-weight:bold;font-style:normal; color:#FFA800;text-decoration:none;letter-spacing: 0px;">                                                     
                                                                                                                                <?php echo strtoupper($value->atas_nama); ?>
                                                                                                                            </td>
                                                                                                                        </tr>  
                                                                                                                        <?php
                                                                                                                    }  //ngatur nomor urut
                                                                                            ...
                                                                                            <table  border="0" cellpadding="0" cellspacing="0" align="center" class="center-float">
                                                                                                <tr>
                                                                                                    <td align="center" valign="top">
                                                                                                        ...
                                                                                                        <table border="0" cellpadding="0" cellspacing="0" align="center" class="center-float">
                                                                                                            <tr>
                                                                                                                <td class="button-bg-option-b" valign="middle" align="center"  bgcolor="#ff7264" style="border-radius: 0px;">
                                                                                                                    <!-- Btn -->
                                                                                                                    <table border="0" cellpadding="0" cellspacing="0" align="center" class="center-float">
                                                                                                                        <tr>
                                                                                                                        ...
                                                                                                                        <tr>
                                                                                                                            ...
                                                                                                                            <td valign="middle" align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:14px;font-weight:bolder;font-style:normal;color:#ff7264;text-decoration:none;letter-spacing:0px;">
                                                                                                                                ...
                                                                                                                                <a href="<?php echo site_url('ppdb/register/check_status_payment'); ?>" target="_blank" style="color:#FFFFFF;">CEK & TATA CARA PEMBAYARAN</a>
        ...
        <table border="0" width="100%" align="center" cellpadding="0" cellspacing="0"style="width:100%;max-width:100%;">
            <tr>
                <td class="title-7" align="center" valign="top">
                                                        ...
                                                        <table   border="0" width="100%" cellpadding="0" cellspacing="0" align="center" style="width:100%; max-width:100%;">
                                                            <tr> 
                                                                <td class="title center-text" valign="middle" align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif; font-size:24px; line-height:28px; font-weight:lighter;font-style:normal; color:#000000;text-decoration:none;letter-spacing: 1px;">
                                                                    ...
                                                                    <strong style="color:#ff7264;" >QURANI</strong> & BERPRESTASI
        ...
        <table border="0" width="100%" align="center" cellpadding="0" cellspacing="0"      style="width:100%;max-width:100%;">
            <tr>
                <td class="miscellaneous" align="center" valign="top">
                                ...
                                <table border="0" width="800" align="center" cellpadding="0" cellspacing="0" class="row" style="width:800px;max-width:800px;">
                                    <tr>
                                        <td class="bg-color-option-a" align="center" valign="top"    bgcolor="#FFFFFF">
                                            ...
                                            <!-- container -->
                                            <table width="800" border="0" cellpadding="0" cellspacing="0" align="center" class="row" style="width:800px;max-width:800px;">
                                                <tr>
                                                    <td align="center" valign="top" class="container-padding">
                                                        ...
                                                        <table border="0" width="100%" align="center" cellpadding="0" cellspacing="0" style="width:100%;max-width:100%;">
                                                            <tr>
                                                                <td class="space-control" valign="middle" align="center" height="30"   >&nbsp;</td>
                                                            </tr>
                                                        </table>
                                                        <!-- space -->
                                                        ...
                                                        <table width="600" border="0" cellpadding="0" cellspacing="0" align="center" class="row" style="width:600px;max-width:600px;">
                                                            <tr>
                                                                <td align="center" valign="top">
                                                                    ...
                                                                    <!-- column -->
                                                                    <table width="180" border="0" cellpadding="0" cellspacing="0" align="left" class="row" style="width:180px;max-width:180px;border-collapse:collapse;">
                                                                        <tr>
                                                                            <td valign="top" align="center">
                                                                                <!-- content -->
                                                                                <table width="160" border="0" cellpadding="0" cellspacing="0" align="center" class="row" style="width:160px;max-width:160px;">
                                                                                    <tr>
                                                                                        <td align="center" valign="top">
                                                                                            ...
                                                                                            <table   border="0" width="100%" cellpadding="0" cellspacing="0" align="center" style="width:100%; max-width:100%;">
                                                                                                <tr>
                                                                                                    <td align="center" valign="middle">
                                                                                                        <table border="0" cellpadding="0" cellspacing="0" align="center" class="center-float">
                                                                                                            <tr> 
                                                                                                                <td class="title center-text"      valign="middle" align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif; font-size:18px; line-height:24px; font-weight:bolder;font-style:italic; color:#ff7264;text-decoration:none;letter-spacing: 0px;">

                                                                                                                    Kelas<br> Internasional
                                                                                            ...
                                                                                            <table   border="0" width="100%" cellpadding="0" cellspacing="0" align="center" style="width:100%; max-width:100%;">
                                                                                                <tr> 
                                                                                                    <td class="text center-text" valign="middle" align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif; font-size:13px; line-height:23px; font-weight:normal;font-style:normal; color:#000000;text-decoration:none;letter-spacing: 0px;">
                                                                                                        ...
                                                                                                        Sekolah "Utsman" menggunakan bilingual bahasa (Indonesia-Inggris) dalam proses pengajaranya.
                                                                                            ...
                                                                                            <table   border="0" width="100%" cellpadding="0" cellspacing="0" align="center" style="width:100%; max-width:100%;">
                                                                                                <tr> 
                                                                                                    <td class="text center-text"      valign="middle" align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif; font-size:13px; line-height:23px; font-weight:normal;font-style:normal; color:#000000;text-decoration:none;letter-spacing: 0px;">
                                                                                                        ...
                                                                                                        Menyiapkan lulusan berkarakter Qur’ani dan Mencintai Al Qur’an adalah mendudukkan Al Qur’an sebagai pedoman.
                                                                                            ...
                                                                                            <table   border="0" width="100%" cellpadding="0" cellspacing="0" align="center" style="width:100%; max-width:100%;">
                                                                                                <tr> 
                                                                                                    <td class="text center-text"  valign="middle" align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif; font-size:13px; line-height:23px; font-weight:normal;font-style:normal; color:#000000;text-decoration:none;letter-spacing: 0px;">
                                                                                                        ...
                                                                                                        Sekolah Utsman telah terakreditasi Badan Akreditasi Nasional (BAN), dan mendapat kategori A.
        ...
        <table border="0" width="100%" align="center" cellpadding="0" cellspacing="0"      style="width:100%;max-width:100%;">
            <tr>
                <td class="socials-1" align="center" valign="top">
                    ...
                    <table border="0" width="100%" align="center" cellpadding="0" cellspacing="0" class="row" style="width:100%;max-width:100%;">
                        <tr>
                            <td class="body-bg-color" align="center" valign="top"    bgcolor="#F4F4F4">
                                ...
                                <table border="0" width="800" align="center" cellpadding="0" cellspacing="0" class="row" style="width:800px;max-width:800px;">
                                    <tr>
                                        <td class="bg-color-option-b" align="center" valign="top"    bgcolor="#000000">

                                            <!-- socials-1-outlook-windows -->
                                            <!--[if (gte mso 9)|(IE)]>
                                            <v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" style="width:800px;height:450px;">
                                            <v:fill type="frame" src="img/socials-1-back.jpg" color="#333333"/>
                                            ...
                                            <table border="0" width="100%" align="center" cellpadding="0" cellspacing="0" class="row" style="width:100%;max-width:100%;">
                                                <tr>
                                                    <td class="bg-image" align="center" valign="top" background="<?php echo base_url() . 'uploads/data/newsletter/socials-1-back.jpg'; ?>"   style="background-size:cover;background-position:center top;">
                                                        ...
                                                        <table width="600" border="0" cellpadding="0" cellspacing="0" align="center" class="row" style="width:600px;max-width:600px;">
                                                            <tr>
                                                                <td align="center" valign="top" class="container-padding">
                                                                    ...
                                                                    <table   border="0" width="100%" cellpadding="0" cellspacing="0" align="center" style="width:100%; max-width:100%;">
                                                                        <tr> 
                                                                            <td class="title center-text"      valign="middle" align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif; font-size:20px; line-height:24px; font-weight:bold;font-style:normal; color:#000000;text-decoration:none;letter-spacing: 3px;">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td valign="middle" align="center"> 
                                                                                            ...
                                                                                            <table   border="0" cellpadding="0" cellspacing="0" style="display:inline-block;vertical-align:middle;">
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td align="center" valign="middle" width="80" class="img36"> <a href="<?php echo $contact[0]->akun_facebook; ?>" target="_blank" style="text-decoration:none;"><img style="display:block;width:100%;max-width:36px;display:block;border:0px;" src="<?php echo base_url() . 'uploads/data/newsletter/facebook-logo.png'; ?>" width="36"  border="0"   alt="facebook"></a></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td align="center" valign="middle" height="10" style="font-size:10px;line-height:10px;"></td>
                                                                                                </tr>
                                                                                            ...
                                                                                            <table   border="0" cellpadding="0" cellspacing="0" style="display:inline-block;vertical-align:middle;">
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td align="center" valign="middle" width="80" class="img36"><a href="<?php echo $contact[0]->akun_twitter; ?>" target="_blank" style="text-decoration:none;"><img style="display:block;width:100%;max-width:36px;display:block;border:0px;" src="<?php echo base_url() . 'uploads/data/newsletter/twitter-logo.png'; ?>" width="36"  border="0"   alt="twitter"></a></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td align="center" valign="middle" height="10" style="font-size:10px;line-height:10px;"></td>
                                                                                                </tr>
                                                                                            ...
                                                                                            <table   border="0" cellpadding="0" cellspacing="0" style="display:inline-block;vertical-align:middle;">
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td align="center" valign="middle" width="80" class="img36"><a href="mailto:<?php echo $contact[0]->akun_youtube ?>" target="_blank" style="text-decoration:none;"><img style="display:block;width:100%;max-width:36px;display:block;border:0px;" src="<?php echo base_url() . 'uploads/data/newsletter/youtube-logo.png'; ?>" width="36"  border="0" alt="youtube"></a></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td align="center" valign="middle" height="10" style="font-size:10px;line-height:10px;"></td>
                                                                                                </tr>
                                                                                            ...
                                                                                            <table   border="0" cellpadding="0" cellspacing="0" style="display:inline-block;vertical-align:middle;">
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td align="center" valign="middle" width="80" class="img36"><a href="<?php echo $contact[0]->akun_instagram; ?>" target="_blank" style="text-decoration:none;"><img style="display:block;width:100%;max-width:36px;display:block;border:0px;" src="<?php echo base_url() . 'uploads/data/newsletter/instagram-logo.png'; ?>" width="36"  border="0"   alt="instagram"></a></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td align="center" valign="middle" height="10" style="font-size:10px;line-height:10px;"></td>
                                                                                                </tr>
        ...
        <table border="0" width="100%" align="center" cellpadding="0" cellspacing="0" style="width:100%;max-width:100%;">
            <tr>
                <td class="unsubscribe" align="center" valign="top">
                                                                    ...
                                                                    <table border="0" cellpadding="0" cellspacing="0" align="center" class="center-float">
                                                                        <tr>
                                                                            <td class="center-text" valign="middle" align="center">
                                                                                ...
                                                                                <table border="0" cellpadding="0" cellspacing="0" align="center" class="center-float">
                                                                                    <tr>
                                                                                        <td class="unsubscribe" valign="middle" align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:12px;font-weight:normal;line-height:12px;color:#FFFFFF;">
