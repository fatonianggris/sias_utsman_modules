												...
												<div class="row mt-2">
													...
													<div class="mb-3">
														<div class="form-group">
															...
															<iframe width="93%" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?q=<?php echo ($present[0]->lat_masuk); ?>,<?php echo ($present[0]->longt_masuk); ?>&hl=es;z=14&amp;output=embed">
															</iframe>
														</div>
													</div>
												...
												<div class="row mt-2">
													...
													<div class="mb-3">
														<div class="form-group">
															...
															<iframe width="93%" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?q=<?php echo ($present[0]->lat_pulang); ?>,<?php echo ($present[0]->longt_pulang); ?>&hl=es;z=14&amp;output=embed">
															</iframe>
														</div>
													</div>
													<div class="col-lg-12 col-12 text-center">
