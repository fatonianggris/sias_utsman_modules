...
<html lang="en">
    ...
    <head><base href="../../../../">
        <meta charset="utf-8" />
        <title>Login Absensi | Sekolah Utsman</title>
    ...
    <body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
        ...
        <div class="d-flex flex-column flex-root">
            ...
            <div class="login login-4 login-signin-on d-flex flex-row-fluid" id="kt_login">
                <div class="d-flex flex-center flex-row-fluid bgi-size-cover bgi-position-top bgi-no-repeat" style="background-image: url('<?php echo base_url(); ?>assets/present/dist/assets/media/bg/bg-2.jpg');">
                    <div class="login-form text-center p-7 position-relative overflow-hidden">
                        ...
                        <div class="login-signin">
                            <div class="mb-8">
                                <h4 class="font-weight-bolder text-white">Login Absensi Pegawai</h4>
                            ...
                            <form class="form" novalidate="novalidate" method="POST" action="<?php echo base_url(); ?>present/auth/login"  id="kt_login_signin_form_present">
                                ...
                                <div class="form-group d-flex flex-wrap justify-content-between align-items-center">
                                    <div class="checkbox-inline">
                                        <label class="checkbox m-0 text-white font-weight-bold">
                            ...
                            <div class="mt-8">
                                <span class="mr-1 text-white">2021©</span>
                                <a href="" target="_blank" class="text-white text-hover-primary">Sekolah Utsman</a>
                            </div>
                        </div>
                        ...
                        <div class="login-forgot">
                            <div class="mb-5">
                                <h3 class="text-danger">Lupa Kata Sandi ?</h3>
                                <div class="text-white font-weight-bold">Silahkan masukkan email anda untuk mereset kata sandi.</div>
                            </div>
        ...
        <script src="<?php echo base_url(); ?>assets/present/dist/assets/js/pages/custom/login/login-present.js"></script>
        <!--end::Page Scripts-->
         <script>
            function act_reset_password() {
                ...
                Swal.fire({
                    ...
                    preConfirm: () => {
                        return $.ajax({
                            type: "post",
                            url: "<?php echo site_url("present/auth/reset_password") ?>",
                            data: {email: email},
                            dataType: 'html',
