			...
			<div class="d-flex flex-center flex-row-fluid bgi-size-cover bgi-position-top bgi-no-repeat" style="background-image: url('<?php echo base_url(); ?>assets/present/dist/assets/media/bg/bg-3.jpg');">
				<div class="login-form text-center p-7 position-relative overflow-hidden">
					...
					<div class="login-signin">
						...
						<div class="text-center">
							<a href="<?php echo site_url('present/auth/logout'); ?>" type="button" class="btn btn-warning button-load font-weight-bold px-9 py-4 my-3 mx-4 mt-1">
						...
						<div class="col-xl-6 col-6">
							...
							<div class="card card-custom gutter-b text-center bg-warning-o-60">
								...
								<div class="card-body">
									...
									<?php if ($present_config[0]->status_absensi_qrcode == 0) { ?>
									...
									<?php } else { ?>
										<a href="<?php echo site_url('present/history/present/do_present_scanner'); ?>" class="btn btn-success btn-shadow-hover button-load font-weight-bold mt-2 "><i class="fa fa-check"></i> Hadir</a>
									<?php } ?>
								</div>
							</div>
							<!--end::Tiles Widget 12-->
