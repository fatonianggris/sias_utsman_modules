...
<html lang="en">
    ...
    <head><base href="../../../../">
        <meta charset="utf-8" />
        <title>Login SIAP | Sekolah Utsman</title>
        ...
        <link href="<?php echo base_url(); ?>assets/employee/dist/assets/css/pages/login/classic/login-4.css" rel="stylesheet" type="text/css" />
    ...
    <body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
        ...
        <div class="d-flex flex-column flex-root">
            ...
            <div class="login login-4 login-signin-on d-flex flex-row-fluid" id="kt_login">
                <div class="d-flex flex-center flex-row-fluid bgi-size-cover bgi-position-top bgi-no-repeat" style="background-image: url('<?php echo base_url(); ?>assets/employee/dist/assets/media/bg/bg-9.jpg');">
                    <div class="login-form text-center p-7 position-relative overflow-hidden">
                        ...
                        <div class="login-signin">
                            <div class="mb-10">
                                <h4 class="font-weight-bolder">Login Sistem Akademik Pegawai</h4>
                                <h1 class="font-weight-bolder text-warning">Sekolah Utsman</h1>
                                <div class="text-danger font-weight-bold">Silahkan login sesuai email dan kata sandi anda:</div>
                            </div>
                            <?php echo $this->session->flashdata('flash_message'); ?>
                            <form class="form" novalidate="novalidate" method="POST" action="<?php echo base_url(); ?>employee/auth/login"  id="kt_login_signin_form_employee">
                                <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                                <div class="form-group mb-5">
                                    <input class="form-control h-auto form-control-solid py-4 px-8" type="email" placeholder="Inputkan Email Anda" name="email" autocomplete="off" />
                                </div>
                                <div class="form-group mb-5">
                                ...
                                <button id="kt_login_signin_submit" class="btn btn-warning font-weight-bold px-9 py-4 my-3 mx-4">Masuk</button>
                            </form>
                            <div class="mt-10">
                        ...
                        <div class="login-forgot">
                            <div class="mb-5">
                                ...
                                <div class="text-danger font-weight-bold">Silahkan masukkan email anda untuk mereset kata sandi.</div>
                            </div>
        ...
        <script src="<?php echo base_url(); ?>assets/employee/dist/assets/js/pages/custom/login/login-general.js"></script>
        <!--end::Page Scripts-->
        <script>
            function act_reset_password() {
                ...
                Swal.fire({
                    ...
                    preConfirm: () => {
                        return $.ajax({
                            type: "post",
                            url: "<?php echo site_url("employee/auth/reset_password") ?>",
                            data: {email: email},
                            dataType: 'html',
