        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-1 mr-5">Akademik Kelas</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        <li class="breadcrumb-item text-muted">
                            <a href="" class="text-muted">Detail Kelas</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
...
<script src="<?php echo base_url(); ?>assets/employee/dist/assets/js/pages/crud/ktdatatable/base/html-table-student-class.js">
</script>
...
<div class="modal fade" id="modal_add_student" tabindex="-1" aria-labelledby="exampleModalSizeLg" aria-hidden="true" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
        <div class="modal-content">
            ...
            <form class="form" method="POST" action="<?php echo site_url('/employee/student/academic/add_student_class/' . paramEncrypt($class[0]->id_kelas)); ?>"  id="kt_form_tingkat">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-10">
                            <div class="form-group">
                                ...
                                <select name="id_siswa[]" id="kt_select2_3" class="form-control form-control-lg select2" multiple="multiple" required="">
                                    <?php
                                    if (!empty($student_grade)) {
                                        foreach ($student_grade as $key => $value) {
                                            ?> 
                                            <option value="<?php echo $value->id_siswa; ?>"><?php echo ucwords(strtolower($value->nama_lengkap)); ?> (<?php echo ucwords(strtolower($value->nis)); ?>)</option>
                                            <?php
                                        }  //ngatur nomor urut
                                    }
                                    ?>          
                                </select> 
                                <span class="form-text text-dark"><b class="text-danger">*WAJIB DIISI, </b>isikan Siswa yang akan diinputkan, boleh lebih dari satu</span>               
                            </div>
                        </div>
                        <div class="col-xl-1">
                        </div>
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-success font-weight-bold mr-2">Tambah</button>
    ...
    function act_release_student(id_siswa, id_kelas, name, nis) {
        ...
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: "post",
                    url: "<?php echo site_url("employee/student/academic/release_student_class") ?>",
