                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        <li class="breadcrumb-item text-muted">
                            <a href="" class="text-muted">Daftar Penilaian Sejawat Pegawai</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
            ...
            <div class="row">
                <div class="col-xl-6">
                    ...
                    <div class="card card-custom bgi-no-repeat gutter-b" style="height: 150px; background-color: #663259; background-position: calc(100% + 0.5rem) 100%; background-size: 100% auto; background-image: url(<?php echo base_url(); ?>assets/employee/dist/assets/media/svg/patterns/taieri.svg)">
                        ...
                        <div class="card-body">
                            <div>
                                <h2 class="text-white font-weight-bolder line-height-lg ">DAFTAR PENILAIAN SEJAWAT
                                </h2>
                            ...
                            <div class="card card-custom bg-primary gutter-b" style="height: 150px">
                                <div class="card-body">
                                    ...
                                    <div class="text-inverse-success font-weight-bolder font-size-h2">
                                        <?php echo $eval_result_colleague[0]->jumlah_sejawat_dinilai; ?>
                                    </div>
                                    <a href="#" class="text-white font-weight-bold font-size-md mt-1">Total Penilaian Sejawat</a>
                                </div>
                            </div>
                            <!--end::Tiles Widget 11-->
                        </div>
                        ...
                        <div class="col-xl-12 col-12">
                            ...
                            <div class="card card-custom bg-danger gutter-b" style="height: 150px">
                                <div class="card-body">
                                    ...
                                    <div class="text-inverse-success font-weight-bolder font-size-h2">
                                        <?php echo $eval_result_colleague[0]->jumlah_sejawat_dinilai - $eval_result_colleague[0]->total_hasil_sejawat_dinilai; ?>
                                    </div>
                        ...
                        <div class="col-xl-12 col-12">
                            ...
                            <div class="card card-custom bg-success gutter-b" style="height: 150px">
                                <div class="card-body">
                                    ...
                                    <div class="text-inverse-success font-weight-bolder font-size-h2">
                                        <?php echo $eval_result_colleague[0]->total_hasil_sejawat_dinilai; ?>
                                    </div>
                ...
                <div class="col-xl-12">
                    ...
                    <div class="card card-custom">
                        <div class="card-body">
                            ...
                            <!--end::Search Form-->
                            <!--begin: Datatable-->
                            <table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable_evalution_colleague">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    <?php
                                    if (!empty($eval_colleague)) {
                                        foreach ($eval_colleague as $key => $value) {
                                    ?>
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                ...
                                                <td>
                                                    <?php echo $value->status_hasil_sejawat_dinilai ?>
                                                </td>
                                                <td>
                                                    <div class="dropdown dropdown-inline">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                            <ul class="navi flex-column navi-hover py-2">
                                                                ...
                                                                <?php if ($value->status_hasil_sejawat_dinilai == 0) { ?>
                                                                    <li class="navi-item">
                                                                        <a href="<?php echo site_url('employee/employe/report/evaluation_questionnaire_colleague/' . paramEncrypt($questionnaire[0]->id_kuisioner) . "/" . paramEncrypt($value->id_pegawai_penilai) . "/" . paramEncrypt($value->id_pegawai_yang_dinilai)); ?>" class="navi-link">
                                                                ...
                                                                <?php } else { ?>
                                                                    <li class="navi-item">
                                                                        <a href="<?php echo site_url('employee/employe/report/history_evaluation_questionnaire_colleague/' . paramEncrypt($questionnaire[0]->id_kuisioner) . "/" . paramEncrypt($value->id_pegawai_penilai) . "/" . paramEncrypt($value->id_pegawai_yang_dinilai)); ?>" class="navi-link">
...
<script src="<?php echo base_url(); ?>assets/employee/dist/assets/js/pages/crud/ktdatatable/base/html-table-evaluation-colleague.js">
</script>