                ...
                <div class="col-xl-12 text-center">
                    ...
                    <div class="card card-custom example example-compact py-3" id="kt_form">
                        <div class="card-header card-title pt-2" style="justify-content: center">
                            <h2 class="card-label font-size-h2 text-center font-weight-bolder">HASIL KUISIONER PENILAIAN PERSONAL/DIRI
                                <span class="text-warning pt-2 font-size-h6 font-weight-bolder d-block"><b class="text-dark-75"></b> "<?php echo strtoupper(strtolower($id_pegawai[0]->nama_lengkap)); ?>"-(<?php echo (($id_pegawai[0]->nip)); ?>)</span>
                        ...
                        <!--begin::Form-->
                        <form class="form" method="POST" action="" enctype="multipart/form-data" id="kt_form_eval_question">
                            <div class="card-body">                             
                                <div class="mb-0">
                                    <div class="mb-0">
                                        <div class=" row fv-plugins-icon-container mb-5">
                                        ...
                                        if (!empty($question)) {
                                            foreach ($question as $key => $value) {
                                                ...
                                                <div class="form-group row fv-plugins-icon-container ">
                                                    ...
                                                    <div class="col-lg-9 text-center">
                                                        <textarea name="soal[]" class="form-control form-control-lg font-weight-bold" style="resize: none;" readonly=""><?php echo ucfirst(strtolower($value->isi_pertanyaan)); ?></textarea>
                                                    </div>
                                                    <div class="col-lg-2 text-center">
                                                        <input type="text" name="jawaban[]" value="<?php echo (($value->isi_jawaban)); ?>" readonly="" class="form-control form-control-lg form-control-solid" placeholder="Isikan Nilai" >
