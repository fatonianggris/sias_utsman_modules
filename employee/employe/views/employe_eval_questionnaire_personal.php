                ...
                <div class="col-xl-12 text-center">
                    ...
                    <div class="card card-custom example example-compact py-3" id="kt_form">
                        <div class="card-header card-title pt-2" style="justify-content: center">
                            <h2 class="card-label font-size-h2 text-center font-weight-bolder">KUISIONER PENILAIAN PERSONAL/DIRI
                                <span class="text-warning pt-2 font-size-h6 font-weight-bolder d-block"><b class="text-dark-75"></b> "<?php echo strtoupper(strtolower($id_dinilai[0]->nama_lengkap)); ?>"-(<?php echo (($id_dinilai[0]->nip)); ?>)</span>
                        ...
                        <!--begin::Form-->
                        <form class="form" method="POST" action="<?php echo site_url('employee/employe/report/post_evaluation_questionnaire_personal/' . paramEncrypt($questionnaire[0]->id_kuisioner) . "/" . paramEncrypt($id_dinilai[0]->id_pegawai)); ?>" enctype="multipart/form-data" id="kt_form_eval_question">
