            ...
            <div class="row">
                ...
                <div class="col-xl-12 text-center">
                    ...
                    <div class="card card-custom example example-compact py-3" id="kt_form">
                        ...
                        <!--begin::Form-->
                        <form class="form" method="POST" action="<?php echo site_url('employee/employe/report/post_eval_questionnaire_friend/' . paramEncrypt($questionnaire[0]->id_kuisioner) . "/" . paramEncrypt($id_pegawai[0]->id_pegawai)); ?>" enctype="multipart/form-data"  id="kt_form_eval_question">
