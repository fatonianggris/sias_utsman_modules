                        ...
                        <div class="container">
                            ...
                            <div class="card card-custom">
                                <div class="card-body">
                                    ...
                                    <!--end: Search Form-->
                                    <!--begin: Datatable-->
                                    <table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable_presence_academic_emp_all">
                                        <thead>
                                            <tr>
                                                <th title="#">#</th>
...
<script src="<?php echo base_url(); ?>assets/employee/dist/assets/js/pages/crud/ktdatatable/base/html-table-employe-presence-all-day.js">
</script>