                            ...
                            <div class="card card-custom bg-danger gutter-b" style="height: 150px">
                                <div class="card-body">
                                    ...
                                    <div class="text-inverse-success font-weight-bolder font-size-h2 mt-3 blink-hard">
                                        <?php echo $result_eval[0]->jumlah_nilai_bawahan; ?>
                                    </div>
                    ...
                    <div class="card card-custom example example-compact py-3" id="kt_form">
                        <div class="card-header card-title pt-2" style="justify-content: center">
                            <h2 class="card-label font-size-h2 text-center font-weight-bolder">HASIL PENILAIAN KUISIONER ATASAN
                                ...
                                <span class="text-primary pt-2 font-size-h6 font-weight-bolder d-block"><b class="text-dark-75"></b>"XXXX XXXX XXXX"-(xxxxxx) MENILAI "<?php echo strtoupper(strtolower($id_dinilai[0]->nama_lengkap)); ?>"-(<?php echo (($id_dinilai[0]->nip)); ?>)</span>
...
<script>
    function generate_evaluation_pdf(id_kuisioner, id_penilai, id_dinilai) {
        ...
        $.ajax({
            type: "POST",
            url: `${HOST_URL}employee/employe/report/print_data_pdf_evaluation_leader`,
            data: {
