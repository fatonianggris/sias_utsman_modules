            ...
            <div class="row">
                <div class="col-xl-6">
                    ...
                    <div class="card card-custom bgi-no-repeat gutter-b" style="height: 150px; background-color: #663259; background-position: calc(100% + 0.5rem) 100%; background-size: 100% auto; background-image: url(<?php echo base_url(); ?>assets/employee/dist/assets/media/svg/patterns/taieri.svg)">
                        ...
                        <div class="card-body">
                            <div>
                                <h2 class="text-white font-weight-bolder line-height-lg ">DAFTAR PENILAIAN DARI SEJAWAT
                                </h2>
                            ...
                            <div class="card card-custom bg-primary gutter-b" style="height: 150px">
                                <div class="card-body">
                                    ...
                                    <div class="text-inverse-success font-weight-bolder font-size-h2">
                                        <?php echo $eval_result_colleague[0]->jumlah_sejawat_penilai; ?>
                                    </div>
                        ...
                        <div class="col-xl-12 col-12">
                            ...
                            <div class="card card-custom bg-danger gutter-b" style="height: 150px">
                                <div class="card-body">
                                    ...
                                    <div class="text-inverse-success font-weight-bolder font-size-h2">
                                        <?php echo $eval_result_colleague[0]->jumlah_sejawat_penilai - $eval_result_colleague[0]->total_hasil_sejawat_penilai; ?>
                                    </div>
                        ...
                        <div class="col-xl-12 col-12">
                            ...
                            <div class="card card-custom bg-success gutter-b" style="height: 150px">
                                <div class="card-body">
                                    ...
                                    <div class="text-inverse-success font-weight-bolder font-size-h2">
                                        <?php echo $eval_result_colleague[0]->total_hasil_sejawat_penilai; ?>
                                    </div>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="ml-4">
                                                            ...
                                                            <a href="#" class="text-muted font-weight-bold font-size-xs text-hover-primary">XXXXXX</a>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <?php echo $value->status_hasil_sejawat_penilai ?>
                                                </td>
                                                <td>
                                                    <div class="dropdown dropdown-inline">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                            <ul class="navi flex-column navi-hover py-2">
                                                                ...
                                                                <?php if ($value->status_hasil_sejawat_penilai == 0) { ?>
                                                                    <li class="navi-item">
                                                                ...
                                                                <?php } else { ?>
                                                                    <li class="navi-item">
                                                                        <a href="<?php echo site_url('employee/employe/report/history_evaluation_questionnaire_colleague_assesed/' . paramEncrypt($questionnaire[0]->id_kuisioner) . "/" . paramEncrypt($value->id_pegawai_penilai) . "/" . paramEncrypt($value->id_pegawai_yang_dinilai)); ?>" class="navi-link">
