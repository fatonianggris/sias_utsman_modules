                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-6">
                                        ...
                                        <div class="card card-custom mb-7">
                                            <div class="card-body d-flex p-0">
                                                <div class="flex-grow-1 bg-success p-5 card-rounded flex-grow-1 bgi-no-repeat" style="height: 120px; background-position: calc(100% + 0.8rem) bottom;background-size: auto 50%; background-image: url(<?php echo base_url(); ?>assets/employee/dist/assets/media/svg/icons/home/Earth.svg);">
                                                    <h4 class="text-inverse-danger font-weight-bolder">Aktifkan Absen Area Lokasi</h4>
                                    ...
                                    <div class="col-lg-4 col-6">
                                        ...
                                        <div class="card card-custom mb-7">
                                            <div class="card-body d-flex p-0">
                                                <div class="flex-grow-1 bg-primary p-5 card-rounded flex-grow-1 bgi-no-repeat" style="height: 120px; background-position: calc(100% + 0.8rem) bottom;background-size: auto 50%;background-image: url(<?php echo base_url(); ?>assets/employee/dist/assets/media/svg/icons/files/Pictures1.svg);">
                                    ...
                                    <div class="col-lg-4 col-6">
                                        ...
                                        <div class="card card-custom mb-7">
                                            <div class="card-body d-flex p-0">
                                                <div class="flex-grow-1 bg-warning p-5 card-rounded flex-grow-1 bgi-no-repeat" style="height: 120px; background-position: calc(100% + 0.8rem) bottom;background-size: auto 50%;background-image: url(<?php echo base_url(); ?>assets/employee/dist/assets/media/svg/icons/home/Clock.svg);">
