                                                    ...
                                                    <div class="dropdown dropdown-inline">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                            <ul class="navi flex-column navi-hover py-2">
                                                                ...
                                                                <?php } else { ?>
                                                                    <li class="navi-item">
                                                                        <a href="<?php echo site_url('employee/master/questionnaire/history_evaluation_questionnaire_leader/' . paramEncrypt($questionnaire[0]->id_kuisioner) . "/" . paramEncrypt($value->id_pegawai_penilai) . "/" . paramEncrypt($value->id_pegawai_yang_dinilai)); ?>" class="navi-link">
