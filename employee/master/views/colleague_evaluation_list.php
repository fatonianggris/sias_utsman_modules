                            ...
                            <div class="card card-custom bg-primary gutter-b" style="height: 150px">
                                <div class="card-body">
                                    ...
                                    <div class="text-inverse-success font-weight-bolder font-size-h2">
                                        <?php echo $eval_result_sejawat[0]->jumlah_sejawat_penilai; ?>
                                    </div>
                        ...
                        <div class="col-xl-12 col-12">
                            ...
                            <div class="card card-custom bg-danger gutter-b" style="height: 150px">
                                <div class="card-body">
                                    ...
                                    <div class="text-inverse-success font-weight-bolder font-size-h2">
                                        <?php echo ($eval_result_sejawat[0]->jumlah_sejawat_penilai - $eval_result_sejawat[0]->total_hasil_sejawat_penilai); ?>
                                    </div>
                        ...
                        <div class="col-xl-12 col-12">
                            ...
                            <div class="card card-custom bg-success gutter-b" style="height: 150px">
                                <div class="card-body">
                                    ...
                                    <div class="text-inverse-success font-weight-bolder font-size-h2">
                                        <?php echo $eval_result_sejawat[0]->total_hasil_sejawat_penilai; ?>
                                    </div>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo $value->status_hasil_sejawat; ?>
                                                </td>
                                                <td>
                                                    <div class="dropdown dropdown-inline">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                            <ul class="navi flex-column navi-hover py-2">
                                                                ...
                                                                <?php if ($value->status_hasil_sejawat == 0) { ?>
                                                                    <li class="navi-item">
