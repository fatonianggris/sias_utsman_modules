    ...
    <table>
        ...
        <tbody>
            ...
            <tr class="section-title">
                ...
                <td class="center"><strong><?php echo $result_eval[0]->jumlah_nilai_atasan; ?></strong></td>
            </tr>
            <tr class="section-title">
                <td colspan="3" class="center"><strong>RATA RATA</strong></td>
                <td class="center"><strong><?php echo round($result_eval[0]->jumlah_nilai_atasan / $total_question, 2); ?></strong></td>
            </tr>
        </tbody>
    </table>
    <br>
