...
<body style="background-image: url('<?php echo base_url() . $page[0]->logo_website ?>');">
    ...
    <table>
        ...
        <tbody>
            ...
            <tr class="section-title">
                ...
                <td class="center"><strong><?php echo $result_eval[0]->jumlah_nilai_personal; ?></strong></td>
            </tr>
            <tr class="section-title">
                <td colspan="3" class="center"><strong>RATA RATA</strong></td>
                <td class="center"><strong><?php echo round($result_eval[0]->jumlah_nilai_personal / $total_question, 2); ?></strong></td>
            </tr>
        </tbody>
    </table>
    <br>
    ...
    <table class="no-border">
        <tr>
            ...
            <td class="no-border center"><br>Pegawai Yang Dinilai, <br> <br> <img src="data:image/png;base64,<?php $qr_code_dinilai; ?>" width="70"><br><br><strong><?php echo ucwords(strtolower($id_dinilai[0]->nama_lengkap)); ?></strong></td>
        </tr>
    </table>
