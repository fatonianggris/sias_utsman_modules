    ...
    <table>
        ...
        <tbody>
            ...
            <tr class="section-title">
                ...
                <td class="center"><strong><?php echo $result_eval[0]->jumlah_nilai_sejawat; ?></strong></td>
            </tr>
            <tr class="section-title">
                <td colspan="3" class="center"><strong>RATA RATA</strong></td>
                <td class="center"><strong><?php echo round($result_eval[0]->jumlah_nilai_sejawat / $total_question, 2); ?></strong></td>
            </tr>
        </tbody>
    </table>
    <br>
