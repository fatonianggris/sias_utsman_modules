                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        <li class="breadcrumb-item text-muted">
                            <a href="" class="text-muted">Edit Pegawai</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="card card-custom example example-compact py-5" id="kt_form">
                        <div class="card-header">
                            <h3 class="card-title font-size-h3">Formulir Edit Pegawai</h3>
                        </div>
                        <!--begin::Form-->
                        <form class="form" method="POST" action="<?php echo site_url('/employee/master/employe/update_employe/' . paramEncrypt($employe[0]->id_pegawai)); ?>" enctype="multipart/form-data"  id="kt_form_pegawai">
                            <input type="hidden" class="txt_csrfname" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">                           
                            <input type="hidden" name="id_pegawai" value="<?php echo $employe[0]->id_pegawai; ?>">
                            <div class="card-body">                             
                                <div class="mb-0">
                                    ...
                                    <div class="mb-0">
                                        <div class="form-group row fv-plugins-icon-container ">
                                            <div class="col-lg-3 mb-3">
                                                ...
                                                <input type="text" name="nik" id="kt_maxlength_pegawai" value="<?php echo $employe[0]->nik; ?>"  maxlength="16" class="form-control form-control-lg form-control-solid" placeholder="Isikan NIK KTP" >
                                            ...
                                            <div class="col-lg-3 mb-3">
                                                ...
                                                <input type="text" name="nip"  value="<?php echo $employe[0]->nip; ?>"  class="form-control form-control-lg form-control-solid" placeholder="Isikan NIP Pegawai" >
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="input-group input-group-lg input-group-solid">
                                                    ...
                                                    <input type="text" name="nama_lengkap" value="<?php echo $employe[0]->nama_lengkap; ?>" class="form-control form-control-lg form-control-solid" placeholder="Isikan Nama Lengkap" >
                                                </div>
                                        ...
                                        <div class="form-group row fv-plugins-icon-container ">
                                            <div class="col-lg-3 mb-3">
                                                ...
                                                <input type="text" name="tempat_lahir" value="<?php echo $employe[0]->tempat_lahir; ?>" class="form-control form-control-lg form-control-solid" placeholder="Isikan Tempat Lahir" >
                                            ...
                                            <div class="col-lg-3 mb-3">
                                                ...
                                                <div class="input-group input-group-lg input-group-solid" id="kt_daterangepicker_5">
                                                    ...
                                                    <input type="text" name="tanggal_lahir" value="<?php echo $employe[0]->tanggal_lahir; ?>"  class="form-control form-control-lg form-control-solid" placeholder="Isikan Tanggal Lahir" >
                                                </div>
                                            ...
                                            <div class="col-lg-3 mb-3">
                                                <label>Email</label>
                                                <input type="text" name="email" value="<?php echo $employe[0]->email; ?>"  class="form-control form-control-lg form-control-solid" placeholder="Isiakan Email" >
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <select name="jenis_kelamin" class="form-control form-control-solid form-control-lg">
                                                    <option value="<?php echo $employe[0]->jenis_kelamin; ?>" selected="">
                                                        <?php
                                        ...
                                        <div class="form-group row fv-plugins-icon-container ">
                                            <div class="col-lg-2 mb-3">
                                                ...
                                                <select name="agama" class="form-control form-control-solid form-control-lg">
                                                    <option value="<?php echo $employe[0]->agama; ?>" selected="">
                                                        <?php
                                            ...
                                            <div class="col-lg-2 mb-3">
                                                ...
                                                <select name="warga_negara" class="form-control form-control-solid form-control-lg">
                                                    <option value="<?php echo $employe[0]->warga_negara; ?>" selected="">
                                                        <?php
                                            ...
                                            <div class="col-lg-3 mb-3">
                                                ...
                                                <select name="status_nikah" class="form-control form-control-solid form-control-lg">
                                                    <option value="<?php echo $employe[0]->status_nikah; ?>" selected="">
                                                        <?php
                                            ...
                                            <div class="col-lg-3 mb-3">
                                                ...
                                                <select name="pendidikan" class="form-control form-control-solid form-control-lg">
                                                    <option value="<?php echo $employe[0]->pendidikan; ?>" selected="">
                                                        <?php
                                                        if ($employe[0]->pendidikan == 1) {
                                                            echo 'Tidak Sekolah';
                                                        } else if ($employe[0]->pendidikan == 2) {
                                                            echo 'SD';
                                                        } else if ($employe[0]->pendidikan == 3) {
                                                            echo 'SMP';
                                                        } else if ($employe[0]->pendidikan == 4) {
                                                            echo 'SMA';
                                                        } else if ($employe[0]->pendidikan == 5) {
                                                            echo 'D-I/D-II';
                                                        } else if ($employe[0]->pendidikan == 6) {
                                                            echo 'D-III';
                                                        } else if ($employe[0]->pendidikan == 7) {
                                                            echo 'D-IV/S1';
                                                        } else if ($employe[0]->pendidikan == 8) {
                                                            echo 'S2/S3';
                                                        }
                                                        ?>
                                                    </option>
                                            ...
                                            <div class="col-xl-2 mb-3">
                                                <div class="form-group ">
                                                    ...
                                                    <div class="input-group input-group-lg input-group-solid">
                                                        <input name="jumlah_anak" type="text" value="<?php echo $employe[0]->jumlah_anak; ?>"  class="form-control form-control-lg form-control-solid" placeholder="Isikan Jumlah Anak"/>
                                                    </div>
                                        ...
                                        <div class="form-group row fv-plugins-icon-container ">
                                            <div class="col-lg-3 mb-3">
                                                ...
                                                <div class="input-group input-group-lg input-group-solid">
                                                    <input name="spesialisasi" value="<?php echo ucwords(strtolower($employe[0]->spesialisasi)); ?>" class="form-control form-control-lg form-control-solid" type="text" placeholder="Isikan Spesialisasi Lulusan"/>
                                                </div>
                                            ...
                                            <div class="col-lg-3 mb-3">
                                                ...
                                                <div class="input-group input-group-lg input-group-solid">
                                                    <input name="program_keahlian" value="<?php echo ucwords(strtolower($employe[0]->program_keahlian)); ?>" class="form-control form-control-lg form-control-solid" type="text" placeholder="Isikan Program Keahlian"/>
                                                </div>
                                            ...
                                            <div class="col-lg-3 mb-3">
                                                ...
                                                <div class="input-group input-group-lg input-group-solid">
                                                    ...
                                                    <input type="text" name="nomor_hp" value="<?php echo $employe[0]->nomor_hp; ?>"  id="kt_maxlength_nohp" class="form-control form-control-lg form-control-solid" maxlength="13"/>
                                                </div>
                                            ...
                                            <div class="col-lg-3 mb-3">
                                                ...
                                                <div class="input-group input-group-lg input-group-solid">
                                                    ...
                                                    <input type="text" name="jam_pelajaran" value="<?php echo $employe[0]->jam_pelajaran; ?>" class="form-control form-control-lg form-control-solid"/>
                                                </div>
                                        ...
                                        <div class="form-group row fv-plugins-icon-container ">
                                            <div class="col-lg-3 mb-3">
                                                ...
                                                <select name="jenis_pegawai" class="form-control form-control-solid form-control-lg">
                                                    <option value="<?php echo $employe[0]->jenis_pegawai; ?>" selected="">
                                                        <?php
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <select name="th_ajaran" class="form-control form-control-solid form-control-lg">
                                                    <option value="<?php echo $employe[0]->th_ajaran; ?>" selected="">
                                    ...
                                    <div class="mb-0">
                                        <div class="form-group row fv-plugins-icon-container ">
                                            <div class="col-lg-4">
                                                ...
                                                <div class="input-group input-group-lg input-group-solid">
                                                    <textarea class="form-control" name="alamat_lengkap" rows="3"><?php echo $employe[0]->alamat_lengkap; ?></textarea>
                                                </div>
                                            ...
                                            <div class="col-lg-4 mb-3">
                                                ...
                                                <select name="provinsi" id="provinsi" class="form-control form-control-lg form-control-solid select2">
                                                    <option value="<?php echo $employe[0]->provinsi; ?>" selected="">
                                                        <?php echo ucwords(strtolower($employe[0]->nama_provinsi)); ?>
                                                    </option>
                                                    <?php
                                                    if (!empty($provinsi)) {
                                        ...
                                        <div class="form-group row fv-plugins-icon-container ">
                                            ...
                                            <div class="col-lg-2" mb-3>
                                                <label >RT </label>
                                                <div class="input-group input-group-lg input-group-solid">
                                                    <input name="rt" type="text" value="<?php echo $employe[0]->rt; ?>" class="form-control form-control-lg form-control-solid" id="kt_maxlength_rt" maxlength="3" placeholder="RT"  />
                                                </div>
                                            ...
                                            <div class="col-lg-2">
                                                <label >RW </label>
                                                <div class="input-group input-group-lg input-group-solid">
                                                    <input name="rw" type="text" value="<?php echo $employe[0]->rw; ?>" class="form-control form-control-lg form-control-solid" id="kt_maxlength_rw" maxlength="3" placeholder="RW" />
                                                </div>
                                        ...
                                        <div class="form-group row fv-plugins-icon-container">
                                            <div class="col-lg-2 mb-3">
                                                <label>Kodepos</label>
                                                <div class="input-group input-group-lg input-group-solid">
                                                    <input name="kodepos" type="text" value="<?php echo $employe[0]->kodepos; ?>" class="form-control form-control-lg form-control-solid" id="kt_maxlength_kodepos" maxlength="6" placeholder="Kodepos" />
                                                </div>
                                            ...
                                            <div class="col-lg-3 mb-3">
                                                ...
                                                <div class="input-group input-group-lg input-group-solid">
                                                    <input name="npwp" value="<?php echo $employe[0]->npwp; ?>" class="form-control form-control-lg form-control-solid" type="text" placeholder="Isikan Nomor NPWP"/>
                                                </div>
                                            ...
                                            <div class="col-lg-4 mb-3">
                                                ...
                                                <div class="input-group input-group-lg input-group-solid">
                                                    <input name="nama_wajib_pajak" value="<?php echo $employe[0]->nama_wajib_pajak; ?>" class="form-control form-control-lg form-control-solid"  type="text" placeholder="Isikan Nama Wajib Pajak" />
                                                </div>
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="input-group input-group-lg input-group-solid">
                                                    ...
                                                    <input type="text" name="tanggal_masuk" value="<?php echo $employe[0]->tanggal_masuk; ?>" id="kt_datepicker_1" class="form-control form-control-lg form-control-solid" placeholder="Isikan Tanggal Masuk" readonly="">
                                                </div>
                                        ...
                                        <div class="form-group row fv-plugins-icon-container">
                                            ...
                                            <div class="col-lg-2 text-center mb-3">
                                                <div class="image-input image-input-outline" id="kt_image" style="background-image: url(<?php echo base_url(); ?>/assets/employee/dist/assets/media/users/blank.png)">
                                                    <?php if ($employe[0]->foto_pegawai != NULL) { ?>
                                                        <div class="image-input-wrapper" style="background-image: url(<?php echo base_url() . $employe[0]->foto_pegawai; ?> "></div>
                                                    <?php } else {?>  
                                                    ...
                                                    <label class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow" data-action="change" data-toggle="tooltip" title="" data-original-title="Change avatar">
                                                        ...
                                                        <input type="hidden" name="img_foto_pegawai" value="<?php echo $employe[0]->foto_pegawai ?>" style="display:none" />
                                                        <input type="hidden" name="img_foto_pegawai_thumb" value="<?php echo $employe[0]->foto_pegawai_thumb; ?>" style="display:none" />
                                                    </label>
                                            ...
                                            <div class="col-lg-3 mb-3">
                                                ...
                                                <select name="level_tingkat" id="tingkat" class="form-control form-control-solid form-control-lg">
                                                    <option value="<?php echo $employe[0]->level_tingkat; ?>" selected="">
                                                        <?php
                                                        if ($employe[0]->level_tingkat == 1) {
                                                            ...
                                                            echo 'SMP';
                                                        } else if ($employe[0]->level_tingkat == 5) {
                                                            echo 'SMA';
                                                        } else if ($employe[0]->level_tingkat == 6) {
                                                            echo 'UMUM';
                                                        }
                                                        ?>
                                                    </option>
                                            ...
                                            <div class="col-lg-3 mb-3">
                                                ...
                                                <span class="form-text text-dark"><b class="text-danger">*WAJIB DIISI, </b>pilih Jabatan Pegawai</span>
                                                <div class="fv-plugins-message-container"></div>
                                            </div>
                                            <div class="col-lg-2 mb-3">
                                                <label>Golongan</label>
                                                <div class="input-group input-group-lg input-group-solid">
                                                    <input name="golongan" type="text" value="<?php echo $employe[0]->golongan; ?>"  class="form-control form-control-lg form-control-solid" placeholder="Gol."/>
                                                </div>
...
<script src="<?php echo base_url(); ?>assets/employee/dist/assets/js/pages/crud/forms/validation/form-controls-emp-edit.js">
</script>
<script>
    $(document).ready(function () {
        var id_pos = <?php echo $employe[0]->level_tingkat; ?>;
        var id_jab = <?php echo $employe[0]->id_jabatan; ?>;

        var url_jab = "<?php echo site_url('employee/master/employe/add_ajax_position'); ?>/" + id_pos + "/" + id_jab;
...
<?php if($employe[0]->provinsi != "" || $employe[0]->provinsi != NULL){ ?>
<script>

    $(document).ready(function () {
        var id_prov = <?php echo $employe[0]->provinsi; ?>;
        var id_kab = <?php echo $employe[0]->kabupaten_kota; ?>;
        var id_kec = <?php echo $employe[0]->kecamatan; ?>;
        var id_des = <?php echo $employe[0]->kelurahan_desa; ?>;
