                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        <li class="breadcrumb-item text-muted">
                            <a href="" class="text-muted">Tambah Siswa</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                ...
                <div class="card-body p-0">
                    ...
                    <div class="wizard wizard-2" id="kt_wizard" data-wizard-state="step-first" data-wizard-clickable="false">
                        ...
                        <div class="wizard-body py-5 px-5 py-lg-20 px-lg-15">
                            ...
                            <div class="row px-4">
                                <div class="col-xl-12">
                                    <form class="form" method="POST" action="<?php echo site_url('/employee/master/student/post_student'); ?>" enctype="multipart/form-data" id="kt_form_student">
                                        ...
                                        <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                                ...
                                                <div class="col-xl-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-lg input-group-solid">
                                                            ...
                                                            <input type="text" name="nik" class="form-control form-control-solid form-control-lg" id="kt_maxlength_nik" maxlength="16" placeholder="Inputkan NIK Siswa" />
                                                        </div>
                                                        <span class="form-text text-dark"><b class="text-danger">*WAJIB DIISI, </b>isikan NIK Siswa yang ada di KK</span>
                                                    </div>
                                                    <!--end::Input-->
                                                </div>
                                                <div class="col-xl-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-lg input-group-solid">
                                                            ...
                                                            <input type="text" name="no_akta_kelahiran" class="form-control form-control-solid form-control-lg" placeholder="Inputkan Nomor Akra Kelahiran" />
                                                        </div>
                                                        <span class="form-text text-dark"><b class="text-danger">*WAJIB DIISI, </b>isikan No. Akta Kelahiran siswa</span>
                                                    </div>
                                                    <!--end::Input-->
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-xl-8">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="nama_lengkap" class="form-control form-control-solid form-control-lg" placeholder="Inputkan Nama Lengkap Siswa" />
                                                ...
                                                <div class="col-xl-4">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="nama_panggilan" class="form-control form-control-solid form-control-lg" placeholder="Inputkan Nama Panggilan Siswa" />
                                            ...
                                            <div class="row">
                                                <div class="col-xl-5">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="tempat_lahir" class="form-control form-control-solid form-control-lg" placeholder="Inputkan Tempat Lahir Siswa" />
                                                ...
                                                <div class="col-xl-4">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-lg input-group-solid" id="kt_daterangepicker_5">
                                                            ...
                                                            <input type="text" name="tanggal_lahir" class="form-control form-control-solid form-control-lg" readonly="readonly" placeholder="Inputkan Tanggal Lahir" />
                                                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-3">
                                                    ...
                                                    <div class="form-group">
                                                        <label>RomBel</label>
                                                        <input name="rombel" type="text" class="form-control form-control-solid form-control-lg" placeholder="Inputkan Rombel Siswa" />
                                            ...
                                            <div class="row">
                                                <div class="col-xl-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-lg input-group-solid">
                                                            ...
                                                            <input type="text" name="nomor_handphone" id="kt_maxlength_nohp" class="form-control form-control-lg form-control-solid" maxlength="13" />
                                                        </div>
                                                ...
                                                <div class="col-xl-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-lg input-group-solid">
                                                            ...
                                                            <input type="text" name="nomor_telepon" class="form-control form-control-lg form-control-solid" placeholder="Inputkan Nomor Telepon" />
                                                        </div>
                                                ...
                                                <div class="col-xl-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-lg input-group-solid">
                                                            <input name="email" type="email" class="form-control form-control-lg form-control-solid" placeholder="Inputkan Email Siswa" />
                                                        </div>
                                        ...
                                        <div class="pb-5" data-wizard-type="step-content">
                                            ...
                                            <div class="row">
                                                <div class="col-xl-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-lg input-group-solid">
                                                            <input type="text" name="nama_ayah" class="form-control form-control-solid form-control-lg" placeholder="Inputkan Nama Lengkap Ayah" />
                                                        </div>
                                                ...
                                                <div class="col-xl-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-lg input-group-solid">
                                                            ...
                                                            <input type="text" name="nik_ayah" class="form-control form-control-solid form-control-lg" id="kt_maxlength_nik_ayah" maxlength="16" placeholder="Inputkan NIK Ayah" />
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-xl-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-lg input-group-solid">
                                                            <input name="tempat_lahir_ayah" type="text" class="form-control form-control-lg form-control-solid" placeholder="Tempat Lahir" />
                                                        </div>
                                                ...
                                                <div class="col-xl-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-lg input-group-solid" id="kt_daterangepicker_ayah">
                                                            ...
                                                            <input name="tanggal_lahir_ayah" type="text" class="form-control form-control-lg form-control-solid" readonly="readonly" placeholder="Inputkan Tanggal Lahir Ayah" />
                                                        </div>
                                                ...
                                                <div class="col-xl-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-lg input-group-solid">
                                                            <input type="text" name="pekerjaan_ayah" class="form-control form-control-lg form-control-solid" placeholder="Inputkan Pekerjaan Ayah" />
                                                        </div>
                                                        <span class="form-text text-dark"><b class="text-danger">*WAJIB DIISI, </b>pilih Pekerjaan Ayah</span>
                                                        <!--end::Select-->
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-2">
                                                    ...
                                                    <span class="switch switch-lg switch-icon">
                                                        <label>
                                                            <input type="checkbox" id="wali_ayah" name="status_wali" value="1">
                                                            <span></span>
                                                        </label>
                                                    </span>
                                            ...
                                            <div class="row">
                                                <div class="col-xl-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-lg input-group-solid">
                                                            <input type="text" name="nama_ibu" class="form-control form-control-solid form-control-lg" placeholder="Inputkan Nama Lengkap Ibu" />
                                                        </div>
                                                ...
                                                <div class="col-xl-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-lg input-group-solid">
                                                            ...
                                                            <input type="text" name="nik_ibu" class="form-control form-control-solid form-control-lg" id="kt_maxlength_nik_ibu" maxlength="16" placeholder="Inputkan NIK Ibu" />
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-xl-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-lg input-group-solid">
                                                            <input name="tempat_lahir_ibu" type="text" class="form-control form-control-lg form-control-solid" placeholder="Tempat Lahir" />
                                                        </div>
                                                ...
                                                <div class="col-xl-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-lg input-group-solid" id="kt_daterangepicker_ibu">
                                                            ...
                                                            <input type="text" name="tanggal_lahir_ibu" class="form-control form-control-lg form-control-solid" readonly="readonly" placeholder="Inputkan Tanggal Lahir Ibu" />
                                                        </div>
                                                ...
                                                <div class="col-xl-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-lg input-group-solid">
                                                            <input name="pekerjaan_ibu" type="text" class="form-control form-control-lg form-control-solid" placeholder="Inputkan Pekerjaan Ibu" />
                                                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-2">
                                                    ...
                                                    <span class="switch switch-lg switch-icon">
                                                        <label>
                                                            <input type="checkbox" id="wali_ibu" name="status_wali" value="2">
                                                            <span></span>
                                                        </label>
                                                    </span>
                                            ...
                                            <div class="row">
                                                <div class="col-xl-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-lg input-group-solid">
                                                            <input name="nama_wali" type="text" class="form-control form-control-solid form-control-lg" placeholder="Inputkan Nama Lengkap Wali" />
                                                        </div>
                                                ...
                                                <div class="col-xl-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-lg input-group-solid">
                                                            ...
                                                            <input name="nik_wali" type="text" class="form-control form-control-solid form-control-lg" id="kt_maxlength_nik_wali" maxlength="16" placeholder="Inputkan NIK Wali" />
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-xl-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-lg input-group-solid">
                                                            <input name="tempat_lahir_wali" type="text" class="form-control form-control-lg form-control-solid" placeholder="Tempat Lahir" />
                                                        </div>
                                                        <span class="form-text text-dark"><b class="text-danger">*WAJIB DIISI, </b>isikan Tempat Lahir Wali</span>
                                                    </div>
                                                </div>
                                                <div class="col-xl-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-lg input-group-solid" id="kt_daterangepicker_wali">
                                                            ...
                                                            <input type="text" name="tanggal_lahir_wali" class="form-control input-group-lg input-group-solid" readonly="" placeholder="Inputkan Tanggal Lahir Wali" />
                                                        </div>
                                                ...
                                                <div class="col-xl-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-lg input-group-solid">
                                                            <input name="pekerjaan_wali" type="text" class="form-control form-control-lg form-control-solid" placeholder="Inputkan Pekerjaan Wali" />
                                                        </div>
                                                        <span class="form-text text-dark"><b class="text-danger">*WAJIB DIISI, </b>pilih Pekerjaan Wali</span>
                                                        <!--end::Select-->
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-xl-12">
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="input-group input-group-lg input-group-solid">
                                                            <textarea class="form-control" name="alamat_rumah_kk" rows="3"></textarea>
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-xl-2">
                                                    <div class="form-group ">
                                                        <label>RT KK</label>
                                                        <div class="input-group input-group-lg input-group-solid">
                                                            <input name="rt_kk" type="text" class="form-control form-control-lg form-control-solid" id="kt_maxlength_rt" maxlength="3" />
                                                        </div>
                                                ...
                                                <div class="col-xl-2">
                                                    <div class="form-group ">
                                                        <label>RW KK</label>
                                                        <div class="input-group input-group-lg input-group-solid">
                                                            <input name="rw_kk" type="text" class="form-control form-control-lg form-control-solid" id="kt_maxlength_rw" maxlength="3" />
                                                        </div>
                                                ...
                                                <div class="col-xl-3">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-lg input-group-solid">
                                                            <input name="kodepos_kk" type="text" class="form-control form-control-lg form-control-solid" id="kt_maxlength_kodepos" maxlength="6" />
                                                        </div>
                                                ...
                                                <div class="col-xl-4">
                                                    ...
                                                    <span class="switch switch-lg switch-icon">
                                                        <label>
                                                            <input type="checkbox" id="alamat" name="status_alamat" value="1">
                                                            <span></span>
                                                        </label>
                                                    </span>
                                            ...
                                            <div class="row">
                                                <div class="col-xl-12">
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="input-group input-group-lg input-group-solid">
                                                            <textarea class="form-control" name="alamat_rumah_dom" rows="3"></textarea>
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-xl-2">
                                                    <div class="form-group ">
                                                        <label>RT Dom.</label>
                                                        <div class="input-group input-group-lg input-group-solid">
                                                            <input name="rt_dom" type="text" class="form-control form-control-lg form-control-solid" placeholder="RT" id="kt_maxlength_rt_dom" maxlength="3" />
                                                        </div>
                                                        <span class="form-text text-dark"><b class="text-danger">*WAJIB DIISI, </b>isikan RT</span>
                                                    </div>
                                                </div>
                                                <div class="col-xl-2">
                                                    <div class="form-group ">
                                                        <label>RW Dom.</label>
                                                        <div class="input-group input-group-lg input-group-solid">
                                                            <input name="rw_dom" type="text" class="form-control form-control-lg form-control-solid" placeholder="RW" id="kt_maxlength_rw_dom" maxlength="3" />
                                                        </div>
                                                        <span class="form-text text-dark"><b class="text-danger">*WAJIB DIISI, </b>isikan RW</span>
                                                    </div>
                                                </div>
                                                <div class="col-xl-3">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-lg input-group-solid">
                                                            <input name="kodepos_dom" type="text" class="form-control form-control-lg form-control-solid" placeholder="Inputkan Kodepos" id="kt_maxlength_kodepos_dom" maxlength="6" />
                                                        </div>
                                                        <span class="form-text text-dark"><b class="text-danger">*WAJIB DIISI, </b>isikan Kodepos</span>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="pb-5" data-wizard-type="step-content">
                                            ...
                                            <div class="row">
                                                <div class="col-xl-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-lg input-group-solid">
                                                            <input name="alat_transportasi" type="text" class="form-control form-control-lg form-control-solid" placeholder="Inputkan Transportasi" />
                                                        </div>
                                                ...
                                                <div class="col-xl-5">
                                                    <div class="form-group">
                                                        ...
                                                        <span class="form-text text-dark"><b class="text-danger">*WAJIB DIISI, </b>pilih Jenis Tempat Tinggal Siswa</span>
                                                    </div>
                                                </div>
                                                <div class="col-xl-3">
                                                    <div class="form-group">
                                                        <label>Jarak Rmh-Sekolah</label>
                                                        <div class="input-group input-group-lg input-group-solid">
                                                            <input name="jarak_rumah_sekolah" type="text" class="form-control form-control-lg form-control-solid" placeholder="Inputkan Jarak Rumah - Sekolah" />
                                                            <div class="input-group-prepend">
                                            ...
                                            <div class="row">
                                                <h6 class="ml-4 mb-5 mt-5 text-danger">Punya Saudara Kandung yang bersekolah di Sekolah Utsman? *isikan jika ada</h6>
                                                <div class="col-xl-4">
                                                    <!--begin::Input-->
                                                    <div class="form-group">
                                                        <label>Nama NIS Saudara</label>
                                                        <input type="text" name="nis_saudara" class="form-control form-control-solid form-control-lg" placeholder="Inputkan NIS Saudara Kandung" />
                                                        <span class="form-text text-dark"><b class="text-dark">*TIDAK WAJIB DIISI, </b>isikan NIS Saudara Kandung yang bersekolah di Utsman</span>
                                                    </div>
                                                    <!--end::Input-->
                                                </div>
                                                <div class="col-xl-8">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="nama_saudara" class="form-control form-control-solid form-control-lg" placeholder="Inputkan Nama Saudara Kandung" />
                                                        <span class="form-text text-dark"><b class="text-dark">*TIDAK WAJIB DIISI, </b>isikan Nama Saudara Kandung yang bersekolah di Utsman</span>
                                                    </div>
                                                    <!--end::Input-->
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-xl-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-lg input-group-solid">
                                                            <input name="jumlah_saudara" type="text" class="form-control form-control-lg form-control-solid" placeholder="Inputkan Jumlah Saudara" />
                                                            <div class="input-group-prepend">
                                                ...
                                                <div class="col-xl-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-lg input-group-solid">
                                                            ...
                                                            <input name="anak_ke" type="text" class="form-control form-control-lg form-control-solid" placeholder="Inputkan Anak ke-" />
                                                        </div>
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="radio-inline">
                                                            <label class="radio radio-lg">
                                                                <input type="radio" name="kebutuhan_khusus" value="0" checked="">
                                                                <span></span>Tidak</label>
                                                            <label class="radio radio-lg">
                                                                <input type="radio" name="kebutuhan_khusus" value="1">
                                                                <span></span>Ya</label>
                                                        </div>
                                                ...
                                                <div class="col-xl-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-lg input-group-solid">
                                                            <input name="tinggi_badan" type="text" class="form-control form-control-lg form-control-solid" placeholder="Inputkan Tinggi Badan" />
                                                ...
                                                <div class="col-xl-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-lg input-group-solid">
                                                            <input name="berat_badan" type="text" class="form-control form-control-lg form-control-solid" placeholder="Inputkan Berat Badan" />
                                                            <div class="input-group-append">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-4 mb-3">
                                                    <div class="form-group">
                                                        ...
                                                        <span class="form-text text-dark"><b class="text-danger">*WAJIB DIISI, </b>isikan Level Tingkat</span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="separator separator-dashed my-5"></div>
                                            <h3 class="mb-10 font-weight-bold text-dark">Informasi Akun Siswa:</h3>
...
<script src="<?php echo base_url(); ?>assets/employee/dist/assets/js/pages/custom/wizard/wizard-student.js">
</script>
...
<script>
    $(document).ready(function () {
        ...
        $("#kabupaten_kota_kk").change(function () {
            id_kab_kk = $(this).val();
            var url = "<?php echo site_url('ppdb/register/add_ajax_kec'); ?>/" + id_prov_kk + "/" + id_kab_kk;
            $('#kecamatan_kk').load(url);
            return false;
        });
        $("#kecamatan_kk").change(function () {
            id_kec_kk = $(this).val()
            var url = "<?php echo site_url('ppdb/register/add_ajax_des'); ?>/" + id_prov_kk + "/" + id_kab_kk + "/" + id_kec_kk;
        ...
        $("#kabupaten_kota_dom").change(function () {
            id_kab_dom = $(this).val();
            var url = "<?php echo site_url('ppdb/register/add_ajax_kec'); ?>/" + id_prov_dom + "/" + id_kab_dom;
            $('#kecamatan_dom').load(url);
            return false;
        });
        $("#kecamatan_dom").change(function () {
            id_kec_dom = $(this).val()
            var url = "<?php echo site_url('ppdb/register/add_ajax_des'); ?>/" + id_prov_dom + "/" + id_kab_dom + "/" + id_kec_dom;
...
<script>
    ...
    $("#tingkat").change(function () {
        id_grade = $(this).val();
        var url = "<?php echo site_url('employee/master/student/add_ajax_grade'); ?>/" + id_grade;
        $('#kelas').load(url);
        return false;
    });
</script>